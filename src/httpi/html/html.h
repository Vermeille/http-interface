...
struct Table : public Tag { Table() : Tag("table") {} };
struct Td : public Tag { Td() : Tag("td") {} };
struct Tr : public Tag { Tr() : Tag("tr") {} };
struct Th : public Tag { Th() : Tag("th") {} };
...
struct Span : public Tag { Span() : Tag("span") {} };
...
class Html {
    ...
    public:
        ...
        const std::string& Get() const {
            //LOG_IF(FATAL, !tags_.empty()) << "Tag " << tags_.top() << " not closed for `" << content_ << "`";
            return content_;
        }
};
